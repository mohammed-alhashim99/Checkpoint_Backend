"""
Django settings for checkpoint_backend project.
...
SECRET_KEY = 'django-insecure-()8!t0j^f@gfs_ad&4ky5p7b87=6$vrs(^39b&yo7$m+rqm560'
...
ROOT_URLCONF = 'checkpoint_backend.urls'
...
WSGI_APPLICATION = 'checkpoint_backend.wsgi.application'
